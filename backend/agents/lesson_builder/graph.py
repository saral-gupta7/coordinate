...
graph.add_node("retrieve_references", retrieve_references_node)
...
graph.add_edge("prepare_context", "retrieve_references")
graph.add_edge("retrieve_references", "draft_lesson")
