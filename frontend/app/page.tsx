...
const agentTrace = ["Validate topic", "Profile learner", "Plan curriculum", "Review outline", "Persist course"];
...
const documentSources = ["Lecture notes", "Research PDF", "Project brief", "Personal notes"];
...
const revealTransition = { duration: 0.6, ease: "easeOut" };
